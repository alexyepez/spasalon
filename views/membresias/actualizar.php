...
<?php include_once __DIR__ . '/../templates/barra.php'; ?>
    ...
    <h1 class="nombre-pagina">Actualizar Membresía</h1>
    <p class="descripcion-pagina">Modifica los valores del formulario para actualizar la membresía</p>
    ...
    <form class="formulario" method="POST">
        ...
        <div class="opciones">
            <input type="submit" class="boton" value="Actualizar Membresía">
